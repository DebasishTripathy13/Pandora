...
This module is self-contained — it does NOT import the ``pandora``
...
def write_json_atomic(
    ...
    already store them. Pandora's value-add is *sharing* those exact
    ...
    try:
        ...
        return False
    tmp = path.with_name(f".{path.name}.pandora.tmp")
