...
model prompt, registers OPPLAN tools from ``pandora.tools.opplan``, and
...
from pandora.tools.opplan import OPPLAN_TOOL_NAMES, build_opplan_tools
...
#: table row. Overridable via ``PANDORA_OPPLAN_MAX_ROWS``.
try:
    _OPPLAN_MAX_ROWS = int(os.environ.get("PANDORA_OPPLAN_MAX_ROWS", "40"))
except ValueError:
    _OPPLAN_MAX_ROWS = 40
