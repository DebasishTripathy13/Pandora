...
1. **Pandora-specific system prompt** — Replaces the generic "Skills System"
...
from pandora.tools.skills import build_load_skill_tool
...
class SkillsMiddleware(BaseSkillsMiddleware):
    ...
    - Pandora-specific system prompt template
    ...
    def __init__(self, *, backend: Any, sources: list[str]) -> None:
        ...
        self.system_prompt_template = PANDORA_SKILLS_PROMPT
