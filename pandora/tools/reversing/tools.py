...
from pandora.tools.reversing.rop import filter_gadgets_by_pattern, find_rop_gadgets
from pandora.tools.reversing.scripts import ghidra_recon_script, r2_recon_script
...
@tool
def bin_ghidra_script(binary: str, script_name: str = "pandora_recon.py") -> str:
