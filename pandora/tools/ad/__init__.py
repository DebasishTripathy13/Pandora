...
from pandora.tools.ad.adcs import ADCSFinding, analyze_adcs_templates
...
from pandora.tools.ad.kerberos import KerberosTicket, classify_hashcat_hash, parse_ticket
