...
The folder name is normalised into the Pandora ``vuln_class`` slug
...
from pandora.tools.references.payloads import BUNDLED_PAYLOADS, PayloadBundle

REPO_SLUG = "payloads-all-the-things"

# Canonical Pandora vuln_class labels used by the rest of the
...
def classify_dir(dir_name: str) -> str | None:
    """Map an upstream folder name to a Pandora vuln_class slug.
