...
``pandora/references/`` knows how to parse. Safe to call multiple
times — ``ensure_cached`` does a fast-forward pull when the clone is
already present.

Usage::

    from pandora.tools.references.hydrate import hydrate_all
    hydrate_all()

or as a one-liner::

    python -m pandora.references.hydrate
...
from pandora.tools.references.cve_poc_index import (
    MRXN_SLUG,
    TRICKEST_SLUG,
    build_index,
    invalidate_cache,
...
from pandora.tools.references.fetch import ReferenceCache, ensure_cached
from pandora.tools.references.h1_corpus import invalidate_corpus_cache
from pandora.tools.references.killchain import invalidate_entries_cache
from pandora.tools.references.methodology import invalidate_chapters_cache
from pandora.tools.references.oneliners import invalidate_recipes_cache
from pandora.tools.references.payloads_ingest import invalidate_merged_cache
