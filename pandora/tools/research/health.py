...
from pandora.tools.research import _state
...
def backend_health() -> dict[str, Any]:
    ...
    payload["neo4j"] = {
        "uri": os.environ.get("PANDORA_NEO4J_URI", ""),
        "user": os.environ.get("PANDORA_NEO4J_USER", ""),
        "database": os.environ.get("PANDORA_NEO4J_DATABASE", "neo4j"),
    }
