...
from pandora.tools.contracts.patterns import scan_solidity_source
from pandora.tools.contracts.slither import ingest_slither_file
from pandora.tools.research import cve as cve_mod
from pandora.tools.research import fuzz as fuzz_mod
from pandora.tools.research.chain import critical_path_score, plan_chains, promote_chain
from pandora.tools.research.graph import (
    SEVERITY_SCORE,
    Edge,
    EdgeKind,
    KnowledgeGraph,
...
from pandora.tools.research.health import backend_health
from pandora.tools.research.patch import PATCH_TOOLS
from pandora.tools.research.sarif import ingest_sarif_file
from pandora.tools.research.scanner_tools import SCANNER_TOOLS
from pandora.tools.reversing.binary import identify_binary
from pandora.tools.reversing.packer import detect_packer
from pandora.tools.reversing.strings import extract_strings, group_by_category
from pandora.tools.reversing.symbols import summarize_symbols
from pandora.tools.web.jwt import parse_token
from pandora.tools.web.oauth import analyze_oauth_callback
from pandora.tools.web.session import analyze_cookie
...
from pandora.tools.research._state import (  # noqa: E402
    _json,
    _kg_backend_name,
    _load,
    _save,
...
async def validate_finding(
    ...
    """
    from pandora.tools.bash.bash import get_sandbox
    from pandora.tools.research.poc import (
        AC,
        AV,
        PR,
        UI,
