...
// ${PANDORA_HOME}/.starred suppresses the prompt permanently after
...
const (
	...
	RepoSlug = "debasishtripathy13/Pandora"
...
func PromptIfNotStarred() {
	ackPath := filepath.Join(config.PandoraHome(), AckFileName)
