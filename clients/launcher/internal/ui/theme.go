...
// Full banner: braille logo + "P A N D O R A" text (≥60 cols)
const bannerFull = "" +
	"⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n" +
	"⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢰⣶⣤⡀⠀⣤⣤⣾⣿⣦⣠⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n" +
	"⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣶⣶⣿⢿⣿⣿⣿⣿⣿⣻⣿⣟⣿⣿⣷⣾⣇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n" +
...
func RenderBanner() string {
	...
	if cols >= bannerLogoWidth {
		return BannerStyle.Render(bannerLogo) + "\n" +
			BannerBold.Render("         P A N D O R A")
	}

	// Narrow terminal — text only
	return BannerBold.Render("P A N D O R A")
}
...
// PandoraTheme returns a custom huh theme with Pandora red branding.
// Based on ThemeCharm for polished visuals, recolored to red.
func PandoraTheme(isDark bool) *huh.Styles {
