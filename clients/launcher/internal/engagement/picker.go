...
// AssistantPandora drives kill-chain execution against an existing engagement.
const AssistantPandora = "pandora"
...
func (m pickerModel) renderConfirmOverlay() string {
	body := lipgloss.JoinVertical(lipgloss.Left,
		...
		confirmHintStyle.Render("Removes ~/.pandora/workspace/"+m.deleteTarget+"/ and all contents."),
...
func newPickerModel(home string, entries []engagementEntry) pickerModel {
	...
	l.Title = "Pandora — pick an engagement"
	l.SetShowHelp(true)
