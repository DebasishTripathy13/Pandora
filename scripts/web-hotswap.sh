...
# running pandora-web container, then signals PID 1 (the entrypoint
...
if [[ "$SKIP_BUILD" == false ]]; then
    ...
    DATABASE_URL="${DATABASE_URL:-postgresql://pandora:pandora@localhost:5432/pandora_web}" \
