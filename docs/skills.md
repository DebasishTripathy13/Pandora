...
| `skills/pandora/` | Pandora | Core orchestration procedures (engagement lifecycle, kill-chain analysis, final report) |
...
5. Restart Pandora — `SkillsMiddleware` discovers skills at agent boot
...
| Agent | Skill sources |
|-------|--------------|
| Pandora | `skills/pandora/`, `skills/shared/` |
