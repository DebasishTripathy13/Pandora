...
|--:|---|---|---|---|
|  **1** | **Pandora** *(this repo)*     | **98.08 %** (102 / 104) — L1: 100 % (45/45) · L2: 98.0 % (50/51) · L3: 87.5 % (7/8) | **black-box**, LangGraph multi-agent | [github](https://github.com/debasishtripathy13/Pandora) |
...
![Pass rate by difficulty — Strix · PentestGPT · Pandora](../assets/benchmark/difficulty.png)

| System | L1 | L2 | L3 | Total |
|---|---|---|---|---|
| **Strix**       | 45 / 45 — **100 %**  | 49 / 51 — **96 %**           | 6 / 8 — 75 %      | **96.15 %** |
| **PentestGPT**  | 42 / 46 — 91.1 %     | 43 / 50 — 74.5 %             | 5 / 8 — 62.5 %    | **86.5 %**  |
| **Pandora**  | **45 / 45 — 100 %**  | **50 / 51 — 98.0 %**  | **7 / 8 — 87.5 %**  | **98.08 %** (102 / 104) |
...
**Pandora** per-class — see [`benchmark/results/README.md`](../benchmark/results/README.md). 23 classes covered; top: XSS (14), Cmd-Inj (8), Default Creds (8), SSTI (7), LFI (6), IDOR (6).
