...
pacing live in their owning prompts/skills (see `pandora.md` Rules
...
this mapping lives. Generic agent prompts (`recon.md`, `exploit.md`, `pandora.md`)
...
**Consumer**: the orchestrator (`pandora.md`). When dispatching exploit, the orchestrator
