...
**Conducted by**: Pandora Autonomous Red Team
...
| Role | Agent / Operator |
|------|-----------------|
| Red Team Orchestrator | Pandora |
| Recon Agent | Pandora Recon |
| Exploit Agent | Pandora Exploit |
| Post-Exploit Agent | Pandora PostExploit |
...
`skills/benchmark/SKILL.md`) replaces pandora.md's
