...
description: "Operational-tier finding template — minimal fields for sub-agent decision support. Heavyweight deliverable promotion lives in skills/pandora/final-report."
...
`skills/pandora/final-report/SKILL.md`).
...
`skills/pandora/final-report/SKILL.md` for the deliverable template.
