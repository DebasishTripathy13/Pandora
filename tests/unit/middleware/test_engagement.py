...
from pandora.middleware.engagement import (
...
from pandora.middleware.opplan import OPPLANState
...
def test_hydrate_pulls_engagement_from_configurable_when_state_empty(
    ...
    monkeypatch.setattr(
        "pandora.middleware.engagement._configurable_from_runnable_config",
