...
from pandora.backends.docker_sandbox import BackgroundJobTracker
from pandora.tools.bash.bash import (
    bash,
    bash_kill,
    bash_output,
    bash_status,
...
def test_bash_uses_engagement_workspace_from_environment(monkeypatch):
    ...
    set_sandbox(sandbox)
    monkeypatch.setenv("PANDORA_ENGAGEMENT", "env-engagement")
