...
# ``pandora.tools.research.bounty`` transitively pulls in
# ``pandora.backends.docker_sandbox`` which requires ``deepagents``.
...
from pandora.tools.research.bounty import (  # noqa: E402
    _COMMONLY_EXCLUDED,
    BOUNTY_TOOLS,
    _normalize_class,
    _severity_label,
)
from pandora.tools.research.graph import (  # noqa: E402
    Edge,
    EdgeKind,
    KnowledgeGraph,
    Node,
...
class TestFindLinkedVuln:
    ...
    def test_finds_via_validates_edge(self) -> None:
        from pandora.tools.research.bounty import _find_linked_vuln
